...
var _EXP_VIDEOS = {
  1: { title: '微课：量子比特与叠加态',  bvid: 'BV1tqQEBhEUq', duration: '约3分钟' },
  2: { title: '微课：量子纠缠与Bell态',  bvid: 'BV1tqQEBhEC8', duration: '约3分钟' },
  3: { title: '微课：Grover量子搜索',    bvid: 'BV1UqQEBhEWm', duration: '约2分钟' },
};
