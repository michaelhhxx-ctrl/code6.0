...
function closeMicroVideo() {
  ...
  // 清空 player，使 B站 iframe 销毁停止播放，防止背景音
  var player = document.getElementById('mc-modal-player');
...
function _mcKeyHandler(e) {
  if (e.key === 'Escape') { closeMicroVideo(); }
}
